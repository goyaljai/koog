...
public interface PromptExecutorAPI : AutoCloseable {
     ...
     * @param hooks Optional executor hooks invoked around model resolution and execution lifecycle events.
     ...
     * @param tools An optional list of `ToolDescriptor` objects that define the tools available for the execution.
     * @param hooks Optional executor hooks invoked around model resolution and streaming lifecycle events.
    ...
    public suspend fun executeMultipleChoices(
        ...
        listOf(execute(prompt, model, tools, hooks))
     ...
     * @param hooks Optional executor hooks invoked around model resolution and moderation lifecycle events.
